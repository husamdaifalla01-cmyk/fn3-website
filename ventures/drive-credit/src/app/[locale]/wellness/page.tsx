...
import WellnessEmailCapture from './EmailCapture'
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://mintbrooks.com/lifestyle/wellness' },
  openGraph: {
    title: 'Wellness — Mintbrooks',
    description:
      'Wellness rituals, sleep routines, and the products that actually support a calmer, more intentional life.',
    type: 'website',
    url: 'https://mintbrooks.com/lifestyle/wellness',
    images: [{ url: 'https://mintbrooks.com/lifestyle/wellness.jpg', width: 1200, height: 630, alt: 'Mintbrooks Wellness' }],
  },
  twitter: {
    ...
    description:
      'Wellness rituals, sleep routines, and the products that actually support a calmer, more intentional life.',
    images: ['https://mintbrooks.com/lifestyle/wellness.jpg'],
  },
}
...
export default async function WellnessPage() {
  const products = getProductsByCategory('wellness', 12)
  const articles = EDITORIAL_ARTICLES.filter(a => a.categorySlug === 'wellness')
  return (
    <div
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to top, rgba(253,250,246,0.97) 0%, rgba(253,250,246,0.5) 45%, rgba(253,250,246,0.06) 100%)',
          }}
        />
        ...
        >
          ...
          >
            The practices, products, and routines that actually stick — and why.
          </p>
