...
const ALL_ARTICLES: Article[] = [
  ...
  { title: 'Hatch Restore Review 2026: Is It Worth the $199?', slug: 'hatch-alarm-clock-review', readTime: '5 min', category: 'Wellness', categorySlug: 'wellness', bg: '#F5EDE5', accent: '#7B5E4A', image: '/wellness.jpg', date: 'February 15, 2026' },
  ...
  { title: "Best Clean Foundation for Beginners (2026): 7 Formulas That Don't Cake", slug: 'clean-foundation-for-beginners', readTime: '7 min', category: 'Beauty', categorySlug: 'beauty', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'April 7, 2026' },
  ...
  { title: '7 Best Neutral Eyeshadow Palettes (2026): Tested & Ranked', slug: 'best-neutral-eyeshadow-palette', readTime: '9 min', category: 'Beauty', categorySlug: 'beauty', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'April 7, 2026' },
  ...
  { title: 'Best Bonding Oils for Damaged Hair: Olaplex No. 7 Review', slug: 'best-hair-bonding-oil-olaplex-7-review', readTime: '9 min', category: 'Beauty', categorySlug: 'hair', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'April 7, 2026' },
  { title: 'Glass Hair Showdown: Kerastase Gloss Absolu vs. Kenra Platinum', slug: 'kerastase-kenra-glass-hair-showdown', readTime: '8 min', category: 'Beauty', categorySlug: 'hair', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'April 7, 2026' },
  { title: 'Kérastase Nutritive 8H Night Serum Review (2026): Worth the $48?', slug: 'kerastase-nutritive-8h-magic-night-serum-review', readTime: '8 min', category: 'Beauty', categorySlug: 'hair', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'April 7, 2026' },
  ...
  { title: 'Best Drip Irrigation Kits for Smart Garden Watering', slug: 'best-drip-irrigation-kits', readTime: '8 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026' },
  { title: '5 Best Drip Irrigation Systems (2026): Tested in Real Gardens', slug: 'best-drip-irrigation-system', readTime: '8 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026' },
  { title: 'Best Garden Tool Sets for Women (2026): Gift-Ready Sets Under $50', slug: 'best-garden-tool-set-for-women-gifts', readTime: '7 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026' },
  { title: 'Best Garden Tool Sets for Women: Gifts & Budget Buys', slug: 'best-garden-tool-sets-for-women', readTime: '7 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026' },
  { title: 'Drip Irrigation Kit Comparison: Find Your Perfect System', slug: 'drip-irrigation-kit-comparison', readTime: '8 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026' },

  // Kitchen — Affiliate
  { title: 'Best Sous Vide Machine 2026: We Tested 8, Here\'s Our #1 Pick', slug: 'best-sous-vide-machine-review', readTime: '9 min', category: 'Kitchen', categorySlug: 'kitchen', bg: '#EDF2E5', accent: '#4A5E2C', image: '/kitchen.jpg', date: 'April 7, 2026' },
  ...
  { title: 'Best Get Well Soon Gift Baskets (2026): 8 Picks That Actually Help', slug: 'best-get-well-soon-gift-baskets', readTime: '8 min', category: 'Wellness', categorySlug: 'wellness', bg: '#F5EDE5', accent: '#7B5E4A', image: '/wellness.jpg', date: 'April 7, 2026' },
  ...
  { title: 'Best Drip Irrigation Systems of 2024: Top Picks for Every Garden', slug: 'best-drip-irrigation-systems', readTime: '8 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 12, 2026', excerpt: 'Discover the best drip irrigation system for your garden in 2024. Our guide helps you choose the top-rated kits for efficient, customizable watering.' },
  ...
  { title: 'Top Garden Tool Sets for Women: Gifts & Practical Picks', slug: 'best-garden-tool-set-for-women', readTime: '11 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 7, 2026', excerpt: 'Discover the best garden tool sets for women, from ergonomic pink tools to comprehensive kits. Find the perfect gift or practical pick for any female gardener.' },
  ...
  { title: 'Best Women\'s Gardening Tool Sets for Every Gardener in 2024', slug: 'best-womens-gardening-tool-set', readTime: '6 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 14, 2026', excerpt: 'Discover the best women\'s gardening tool sets of 2024, featuring lightweight, durable, and stylish options perfect for every gardener. Find your ideal ladies garden tool set today.' },
  ...
  { title: 'How to Install a Drip Irrigation System: A Beginner\'s Guide', slug: 'how-to-install-drip-irrigation-beginner-guide', readTime: '6 min', category: 'Home & Decor', categorySlug: 'garden', bg: '#EEF3F1', accent: '#2C4A3E', image: '/home-decor.jpg', date: 'April 18, 2026', excerpt: 'Learn how to install a drip irrigation system with this easy DIY guide, perfect for beginners looking to set up their garden drip system effortlessly. Get started today!' },
  ...
  { title: 'Best Eyeshadow Palette for Everyday Neutral Looks 2024: Tested & Ranked', slug: 'best-eyeshadow-palette-everyday-neutral-looks-2024', readTime: '11 min', category: 'Beauty', categorySlug: 'beauty', bg: '#F5EAF0', accent: '#8B4E6B', image: '/beauty.jpg', date: 'June 26, 2026', excerpt: 'Discover the best eyeshadow palette for everyday neutral looks in 2024—tested by real buyers for office-friendly, natural makeup. Top pick: Too Faced Born This Way.' },
]
...
export async function generateMetadata({
  ...
  // One canonical for the whole locale cluster: /en/. The bare /articles/ URL 404s in
  // this build (it was the old canonical - every ranked URL pointed at a dead page),
  // and 9 machine-translated duplicates were splitting ranking signal ten ways.
  const canonical = `https://mintbrooks.com/en/articles/${slug}`
...
export default async function ArticleDetailPage({
  ...
  const canonicalUrl = `https://mintbrooks.com/en/articles/${slug}`
  const jsonLd = {
