...
export default function HomeDecorEmailCapture() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/lifestyle/subscribe', {
        ...
        body: JSON.stringify({ email, source: 'home-decor' }),
      })
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Join readers building a home they love. Unsubscribe anytime.
        </p>
      </div>
    </section>
  )
