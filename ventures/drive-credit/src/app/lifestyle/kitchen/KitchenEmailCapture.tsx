...
export default function KitchenEmailCapture() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/lifestyle/subscribe', {
        ...
        body: JSON.stringify({ email, source: 'kitchen' }),
      })
      ...
      >
        ...
        {status === 'success' ? (
          ...
          >
            ...
            The best of the kitchen edit lands in your inbox next send.
          </div>
        ) : (
          <form
