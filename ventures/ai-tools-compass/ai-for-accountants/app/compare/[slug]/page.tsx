...
import { getComparisonBySlug, getAllSlugs, accountingComparisons } from "@/data/comparisons";
import { getToolById, accountingTools } from "@/data/tools";
...
export default function ComparisonPage({ params }: Props) {
  ...
  const relatedComparisons = accountingComparisons
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        {winner && (
          <div className="mb-10 rounded-2xl border border-[#2563eb]/30 bg-[#2563eb]/5 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-xl border border-green-500/20 bg-[#111] p-4">
                ...
                <a
                  ...
                  className="mt-3 inline-block rounded-lg bg-[#2563eb] px-4 py-2 text-sm font-medium text-white"
                >
                  Try {winner.name} →
                </a>
              </div>
        ...
        <div className="mb-12">
          ...
          {tools.length > 0 && (
            <ComparisonTable tools={tools as any} accentColor="#2563eb" />
          )}
        </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#2563eb]/20 text-base font-bold text-[#2563eb]">
                  ...
                  <div className="mt-5 flex gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer nofollow"
                      className="rounded-lg bg-[#2563eb] px-5 py-2.5 text-sm font-medium text-white"
                    >
                      Try {tool.name} →
                    </a>
                    <a
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            {comparison.faqs.map((faq, i) => (
              ...
              >
                <summary className="flex cursor-pointer items-center justify-between p-5 text-left font-medium text-white hover:text-[#2563eb]">
                  {faq.question}
                  <svg
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {relatedComparisons.map((c) => (
                <Link
                  key={c.slug}
                  href={`/compare/${c.slug}`}
                  className="rounded-xl border border-white/10 bg-[#111] p-4 transition-all hover:border-[#2563eb]/30"
                >
                  <p className="font-medium text-white hover:text-[#2563eb]">{c.title}</p>
