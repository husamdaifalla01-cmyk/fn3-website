"use strict";(()=>{var e={};e.id=926,e.ids=[926],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},7561:e=>{e.exports=require("node:fs")},4492:e=>{e.exports=require("node:stream")},2477:e=>{e.exports=require("node:stream/web")},1017:e=>{e.exports=require("path")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},1267:e=>{e.exports=require("worker_threads")},9796:e=>{e.exports=require("zlib")},6300:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>d,staticGenerationAsyncStorage:()=>m});var n={};i.r(n),i.d(n,{POST:()=>c});var a=i(9303),r=i(8716),o=i(670),s=i(7070),l=i(8027);async function c(e){try{let{employeeName:t,role:n,state:a,terminationType:r,lastDay:o,reason:c,salary:p}=await e.json();if(!t||!n||!a||!r||!o||!c||!p)return s.NextResponse.json({error:"Missing required fields"},{status:400});let u=new(await i.e(966).then(i.bind(i,3966))).default({apiKey:process.env.ANTHROPIC_API_KEY}),m=(0,l.he)({employeeName:t,role:n,state:a,terminationType:r,lastDay:o,reason:c,salary:p}),d=(await u.messages.create({model:"claude-sonnet-4-6",max_tokens:2048,messages:[{role:"user",content:m}]})).content[0];if("text"!==d.type)throw Error("Unexpected response type from Claude");return s.NextResponse.json({result:d.text})}catch(e){return console.error("Error generating termination docs:",e),s.NextResponse.json({error:"Failed to generate termination documentation"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/generate-termination/route",pathname:"/api/generate-termination",filename:"route",bundlePath:"app/api/generate-termination/route"},resolvedPagePath:"/Users/husamahmed/FN3/ventures/hrmind/app/api/generate-termination/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:d}=p,y="/api/generate-termination/route";function g(){return(0,o.patchFetch)({serverHooks:d,staticGenerationAsyncStorage:m})}},8027:(e,t,i)=>{function n(e){return`Generate a comprehensive new employee onboarding plan for:
Role: ${e.role}
State: ${e.state}
Start date: ${e.date}
Company size: ${e.size}
...
Format each section clearly with headers and bullet points. Be specific and actionable.`}function a(e){return`Write a professional employee handbook section on: ${e.topic}
...
Format your responses clearly with headers when appropriate. Be thorough but concise.`}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),n=t.X(0,[948,972],()=>i(6300));module.exports=n})();