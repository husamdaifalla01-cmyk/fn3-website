"use strict";(()=>{var e={};e.id=144,e.ids=[144],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},7561:e=>{e.exports=require("node:fs")},4492:e=>{e.exports=require("node:stream")},2477:e=>{e.exports=require("node:stream/web")},1017:e=>{e.exports=require("path")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},1267:e=>{e.exports=require("worker_threads")},9796:e=>{e.exports=require("zlib")},2678:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>g,patchFetch:()=>y,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var n={};i.r(n),i.d(n,{POST:()=>c});var a=i(9303),r=i(8716),o=i(670),s=i(7070),l=i(8027);async function c(e){try{let{role:t,state:n,date:a,size:r}=await e.json();if(!t||!n||!a||!r)return s.NextResponse.json({error:"Missing required fields: role, state, date, size"},{status:400});let o=new(await i.e(966).then(i.bind(i,3966))).default({apiKey:process.env.ANTHROPIC_API_KEY}),c=(0,l.MM)({role:t,state:n,date:a,size:r}),p=(await o.messages.create({model:"claude-sonnet-4-6",max_tokens:2048,messages:[{role:"user",content:c}]})).content[0];if("text"!==p.type)throw Error("Unexpected response type from Claude");return s.NextResponse.json({result:p.text})}catch(e){return console.error("Error generating onboarding plan:",e),s.NextResponse.json({error:"Failed to generate onboarding plan"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/generate-onboarding/route",pathname:"/api/generate-onboarding",filename:"route",bundlePath:"app/api/generate-onboarding/route"},resolvedPagePath:"/Users/husamahmed/FN3/ventures/hrmind/app/api/generate-onboarding/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:u,staticGenerationAsyncStorage:d,serverHooks:m}=p,g="/api/generate-onboarding/route";function y(){return(0,o.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},8027:(e,t,i)=>{function n(e){return`Generate a comprehensive new employee onboarding plan for:
Role: ${e.role}
State: ${e.state}
Start date: ${e.date}
Company size: ${e.size}
...
Format your responses clearly with headers when appropriate. Be thorough but concise.`}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),n=t.X(0,[948,972],()=>i(2678));module.exports=n})();