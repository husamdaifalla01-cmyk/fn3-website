"use strict";(()=>{var e={};e.id=783,e.ids=[783],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},7561:e=>{e.exports=require("node:fs")},4492:e=>{e.exports=require("node:stream")},2477:e=>{e.exports=require("node:stream/web")},1017:e=>{e.exports=require("path")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},1267:e=>{e.exports=require("worker_threads")},9796:e=>{e.exports=require("zlib")},7512:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var n={};i.r(n),i.d(n,{POST:()=>c});var r=i(9303),a=i(8716),o=i(670),s=i(7070),l=i(8027);async function c(e){try{let{title:t,department:n,location:r,remote:a,salary:o,responsibilities:c}=await e.json();if(!t||!n||!r||!a||!o||!c)return s.NextResponse.json({error:"Missing required fields"},{status:400});let p=new(await i.e(966).then(i.bind(i,3966))).default({apiKey:process.env.ANTHROPIC_API_KEY}),u=(0,l.rk)({title:t,department:n,location:r,remote:a,salary:o,responsibilities:c}),d=(await p.messages.create({model:"claude-sonnet-4-6",max_tokens:2048,messages:[{role:"user",content:u}]})).content[0];if("text"!==d.type)throw Error("Unexpected response type from Claude");return s.NextResponse.json({result:d.text})}catch(e){return console.error("Error generating job description:",e),s.NextResponse.json({error:"Failed to generate job description"},{status:500})}}let p=new r.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/generate-job-description/route",pathname:"/api/generate-job-description",filename:"route",bundlePath:"app/api/generate-job-description/route"},resolvedPagePath:"/Users/husamahmed/FN3/ventures/hrmind/app/api/generate-job-description/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:u,staticGenerationAsyncStorage:d,serverHooks:m}=p,y="/api/generate-job-description/route";function g(){return(0,o.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},8027:(e,t,i)=>{function n(e){return`Generate a comprehensive new employee onboarding plan for:
Role: ${e.role}
State: ${e.state}
Start date: ${e.date}
Company size: ${e.size}
...
Write in professional, clear language that employees can understand. Avoid legalese but ensure it is legally sound. Reference relevant federal statutes (e.g., FMLA, ADA, Title VII) and ${e.state} state law where applicable.`}function a(e){return`Write a performance review for:
...
Format your responses clearly with headers when appropriate. Be thorough but concise.`}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),n=t.X(0,[948,972],()=>i(7512));module.exports=n})();