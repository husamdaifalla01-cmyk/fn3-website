"use strict";(()=>{var e={};e.id=969,e.ids=[969],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},7561:e=>{e.exports=require("node:fs")},4492:e=>{e.exports=require("node:stream")},2477:e=>{e.exports=require("node:stream/web")},1017:e=>{e.exports=require("path")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},1267:e=>{e.exports=require("worker_threads")},9796:e=>{e.exports=require("zlib")},367:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d});var r={};i.r(r),i.d(r,{POST:()=>c});var a=i(9303),n=i(8716),o=i(670),s=i(7070),l=i(8027);async function c(e){try{let{employeeName:t,role:r,period:a,rating:n,accomplishments:o,improvements:c}=await e.json();if(!t||!r||!a||!n||!o||!c)return s.NextResponse.json({error:"Missing required fields"},{status:400});let p=new(await i.e(966).then(i.bind(i,3966))).default({apiKey:process.env.ANTHROPIC_API_KEY}),u=(0,l.Cd)({employeeName:t,role:r,period:a,rating:n,accomplishments:o,improvements:c}),d=(await p.messages.create({model:"claude-sonnet-4-6",max_tokens:2048,messages:[{role:"user",content:u}]})).content[0];if("text"!==d.type)throw Error("Unexpected response type from Claude");return s.NextResponse.json({result:d.text})}catch(e){return console.error("Error generating review:",e),s.NextResponse.json({error:"Failed to generate performance review"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/generate-review/route",pathname:"/api/generate-review",filename:"route",bundlePath:"app/api/generate-review/route"},resolvedPagePath:"/Users/husamahmed/FN3/ventures/hrmind/app/api/generate-review/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:d,serverHooks:m}=p,y="/api/generate-review/route";function g(){return(0,o.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}},8027:(e,t,i)=>{function r(e){return`Generate a comprehensive new employee onboarding plan for:
Role: ${e.role}
State: ${e.state}
Start date: ${e.date}
Company size: ${e.size}
...
Format your responses clearly with headers when appropriate. Be thorough but concise.`}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),r=t.X(0,[948,972],()=>i(367));module.exports=r})();