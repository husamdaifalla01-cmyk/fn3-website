...
export default function Navbar({
  ...
  return (
    <header className={cn("sticky top-0 z-50 -mb-4 px-4 pb-4", className)}>
      {/* Remove fade overlay completely to eliminate any potential background */}
      <div className="max-w-container relative mx-auto">
        <NavbarComponent>
          <NavbarLeft>
            <a
              href={homeUrl}
              className="flex items-center gap-2 text-xl font-bold drop-shadow-[0_1px_3px_rgba(0,0,0,0.5)]"
            >
              {logo}
